...
@Service
public class CuvanjeUrednikaCasopis implements JavaDelegate {
    ...
    public void execute(DelegateExecution delegateExecution) throws Exception {
        System.out.println("[CuvanjeUrednikaCasopis]: start");
        ...
        _casopisService.saveGroupMembers(casopisForm, casopisId, "urednici");
